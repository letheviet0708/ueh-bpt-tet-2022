...
class GiaiDoan1Check extends Component {
        ...
        return(<React.Fragment>
            <Box sx={{ '& > *': { borderBottom: 'unset' }, display: "flex" }}>
                ...
                <Box sx={{display: "flex" ,
                  ...
                  <Typography sx={{ marginTop: "auto", fontWeight: "bold"}} gutterBottom >Giai Đoạn 1</Typography>
                ...
                <Collapse in={this.state.open} timeout="auto" unmountOnExit>
                  <Box sx={{ margin: 1}}>
                    ...
                    <Box sx={{display: "flex"}}>
                      ...
                      <Box sx={{ml:"10px", boxShadow:4, flexGrow:1, borderRadius:"15px"}}>
                        <Typography sx={{m:"5px"}}>{this.props.result.text[0]}</Typography>
                      </Box>
